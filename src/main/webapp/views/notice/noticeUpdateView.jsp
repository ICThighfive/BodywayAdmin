...
<h1 align="center">1번 공지글 수정 페이지</h1>
<br>
...
<div class="col text-center">
	...
	<input type="button" class="btn btn-outline-primary btn-sm" value="목록" onclick="javascript:location.href='/semi/views/notice/noticeAdminListView.jsp'; return false;"> &nbsp;
</div>
</th></tr>
</table>
</form>
